...
const render = (img: RenderArg) => <div style={{ position: 'absolute', inset: '0' }}>{img.src}</div>

export default function BasicPage() {
    return (
        <div className="flex flex-col gap-10 w-full">
            <ReactGallery breakpoints={breakpoints} ratios={ratios} images={images} render={render} />
        </div>
    )
}
